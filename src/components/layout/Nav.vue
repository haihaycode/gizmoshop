      ...
      <div class="relative max-w-7xl flex items-center mx-auto justify-between h-16">
        ...
        <div class="hidden md:flex items-center justify-center w-3/5 px-4">
          <div class="relative w-full">
            <input type="text" v-model="searchQuery" @input="handleSearch" placeholder="Tìm kiếm sản phẩm..."
            ...
            <!-- Search icon -->
            <span class="absolute right-3 top-1/2 transform -translate-y-1/2 text-xl text-red-500">
        ...
        <div class="flex items-center justify-between h-full">
          ...
          <div class="w-full px-4">
            <div class="relative w-full">
              ...
              <!-- Search icon -->
              <span class="absolute right-3 top-1/2 transform -translate-y-1/2 text-xl text-gray-500">
                <i class="bx bx-search"></i>
              </span>
            </div>
          </div>
    ...
    <transition name="fade">
      <div v-if="isProfileOpen" class="absolute top-20 right-8 bg-gray-50 p-4 rounded-sm shadow-lg w-72 z-50">
        ...
        <ul>
          ...
          <li class="flex items-center px-2 py-1 hover:bg-gray-100 cursor-pointer">
