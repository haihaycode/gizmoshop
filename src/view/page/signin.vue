        ...
        >
          ...
          <form class="w-full max-w-sm">
            <input
              ...
              required
              class="w-full p-4 mb-4 bg-gray-100 text-gray-700 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-600 transition duration-200 shadow-md"
            />
            <input
              type="email"
              placeholder="Email"
